...
def test_se_image_get_wcs_inverse(se_image_data, coadd_image_data):
    ...
    def se_image2sky(x, y):
        ...
        ra, dec = se_wcs._radec(
            np.atleast_1d(x) - se_wcs.x0 + 1,
            np.atleast_1d(y) - se_wcs.y0 + 1)
    ...
    coadd_x = coadd_pos[0] - 1
    coadd_y = coadd_pos[1] - 1
